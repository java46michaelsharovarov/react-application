...
export const ROUTES: RouteType[] = [
    ...
    {path: STATISTIC_HOURS_PATH, label: 'Statistic Hours', element: <StatisticHours/>, icon: <AccessTimeIcon color="primary"/>, authenticated: true, forUser: true},
    {path: STATISTIC_COST_PATH, label: 'Statistic Cost', element: <StatisticCost/>, icon: <AttachMoneyIcon color="primary"/>, authenticated: true, forUser: true},
    {path: LOGIN_PATH, label: 'Login', element: <Login/>, icon: <LoginIcon color="primary"/>},
    {path: LOGOUT_PATH, label: 'Logout', element: <Logout/>, icon: <LogoutIcon color="primary"/>, authenticated: true, forUser: true},
